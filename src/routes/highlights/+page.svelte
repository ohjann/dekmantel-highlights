    ...
    <Timeline position="alternate" style="padding: 0">
      {#each acts as act}
        <TimelineItem>
          ...
          <TimelineContent>
            <Card.Root class="bg-[#8fa1ae] border-[#6a6b59] border-4 rounded-none text-left sm:max-w-none max-w-[40vw] sm:overflow-auto" id="{act.artistName}">
              <Card.Header class="pb-1">
                ...
                <Card.Title class="font-custom tracking-wide text-[#6a6b59]"><a href="#{act.artistName}">{act.artistName}</a></Card.Title>
                <Card.Description>
              ...
              <Card.Content>
                <p class="font-custom text-[#303032] hyphens-auto break-words">{act.description}</p>
